...
class SnLaws {
	...
	public:
		...
		static double calc_rho_vs(const double& Tem);
		static double calc_drho_vs_dT(const double& Tem);
		static double compSnowThermalConductivity_airEff_Hansen(const ElementData& Edata);
		static double compSnowThermalConductivity_waterEff_Hansen(const ElementData& Edata);
		static double compSnowThermalConductivity_iceEff_Hansen(const ElementData& Edata);
		static double compSnowThermalConductivity_Hansen(const ElementData& Edata);

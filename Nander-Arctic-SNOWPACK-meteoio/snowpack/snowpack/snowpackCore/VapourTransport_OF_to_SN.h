...
*/
/**
 * @file VapourTransport_OF_to_SN.h
 */

#ifndef VAPOURTRANSPORT_OF_TO_SN_H
#define VAPOURTRANSPORT_OF_TO_SN_H
...
/**
 * @class VapourTransport_OF_to_SN
 * @version 1.0
 * @brief This module contains water vapour transport routines for the 1d snowpack model
 */
class VapourTransport_OF_to_SN : public WaterTransport {
	public:
		VapourTransport_OF_to_SN(const SnowpackConfig& cfg);

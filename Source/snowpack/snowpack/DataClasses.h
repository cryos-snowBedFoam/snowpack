...
class ElementData {
	public:
		...
		//
		double SN_to_OF_deltaTheta_ice;  ///< the ice fraction change due to all processes such as settling, metamorphism, melting-freezing and etc except for vapor transport (-)
		double SN_to_OF_deltaTheta_water;  ///< the water fraction change due to all processes such as settling, metamorphism, melting-freezing and etc except for vapor transport (-)
		double OF_to_SN_Tm;  ///< the averaged temperature over x in OpenFOAM  (K)
		double OF_to_SN_gradTm;  ///< the averaged temperature gradient over x in OpenFOAM  (K m-1)
		double OF_to_SN_Ra;  ///< the averaged Rayleigh number over x in OpenFOAM  (-)
		double OF_to_SN_Ug;  ///< the averaged gas flow velocity over x in OpenFOAM  (m s-1)
};
